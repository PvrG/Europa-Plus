...
ent-PowerpackRifle = силовой ранец (.15 безгильзовые)
    .desc = Сверх-тяжелый ранец набитый патронами, крепится к силовому креплению, что значительно разгружает вес для оператора, имеет ленточную систему подачи боеприпасов.
...
ent-WeaponRifleSR127 = Затворная винтовка Bauer SR-127
    .desc = Bauer SR-127 - это стандартная винтовка с затвором, используемая Объединенным правительством Земли. Известен своей точностью на дальних дистанциях и используется стрелками, несмотря на свой возраст и отсутствие IFF. У него несъемный прицел. Использует магазины 60-го калибра, которые спокойно разрывают материалы."
    .suffix = Винтовка
...
ent-PowerpackEnergyPulse = силовой ранец (импульсный)
    .desc = Сверх-тяжелый ранец с системой "Powerpack", крайне взрывоопасен из-за сверх-проводящих батарей внутри корпуса наполненых охлажденной жидкой плазмой.
